  ...
  return (
    <main>
      ...
      <div className="disclaimer">
        ...
        拡大の「大きさ」と「写る菌の数」を分ける実験もしましたが、<strong>背景を平らに塗り直すだけで誤りが最大 35 ポイント動き</strong>、
        測る前に決めた確認に落ちたので判定していません。
        その背景の効果も規則を先に書いて確かめましたが、<strong>背景を平らにすると正しく答えていた陽性球菌の誤りが 46 ポイント悪化し</strong>、
        やはり判定していません。陰性球菌は正しい側へ、陽性球菌は誤った側へ動くので、背景に球菌らしさの手がかりがあるとは読めません。
        最後に、画像を作り替えずに Grad-CAM で見る場所を確かめると、
        <strong>誤って桿菌と答えるときもモデルは菌体を見ていて、正しく球菌と答えるときと寄り方が変わりませんでした</strong>。
        背景ではなく菌体を見たうえで桿菌と読んでいます。菌体の何を読んでいるかは、まだ分かっていません。
      </div>
      <p className="muted">
